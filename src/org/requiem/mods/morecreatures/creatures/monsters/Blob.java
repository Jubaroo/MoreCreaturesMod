...
public class Blob implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        final CreatureTemplateBuilder builder = new CreatureTemplateBuilder(BLOB, "Blob", "A gelatinous mass that was discovered inside of a deep cave long lost. It is resistant to magic", "model.blob", types, BodyTemplate.TYPE_SPIDER, (short) 15, (byte) 0, (short) 150, (short) 100, (short) 150, "sound.death.spider", "sound.death.spider", "sound.combat.hit.spider", "sound.combat.hit.spider", 0.09f, 3.8f, 0.0f, 12.0f, 0.0f, 0.0f, 0.8f, 2500, itemsButchered, 30, 90);
