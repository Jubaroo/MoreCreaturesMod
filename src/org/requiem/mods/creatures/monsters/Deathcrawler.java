...
public class Deathcrawler implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.boar",
                "Large boar",
                "A large and strong boar.",
                "model.creature.quadraped.boar.wild",
                types, BodyTemplate.TYPE_DOG,
                (short) 5,
                (byte) 0,
                (short) 85, (short) 50, (short) 85,
                "sound.death.pig", "sound.death.pig", "sound.combat.hit.pig", "sound.combat.hit.pig",
                0.5f,
                8f, 0f, 10.0f, 14.0f, 0.0f,
                1.2f,
                500,
