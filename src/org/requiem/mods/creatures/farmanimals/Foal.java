...
public class Foal implements ModCreature
{

    @Override
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        return new CreatureTemplateBuilder(65) {
            public CreatureTemplate build() {
                try {
                    return CreatureTemplateFactory.getInstance().getTemplate(65);
                }
    ...
    public void assignTraits(final TraitsSetter traitsSetter) {
        if (Server.rand.nextInt(18) == 0) {
            traitsSetter.setTraitBit(26, true);
        }
        else if (Server.rand.nextInt(18) == 0) {
            ...
            traitsSetter.setTraitBit(45, true);
        }
    }
}
